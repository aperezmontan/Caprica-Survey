...
db = URI.parse(ENV['postgres://vzanttbnchwfzq:BZU2ZDfJr5bGZj3CvcT1zbMgy8@ec2-50-19-233-111.compute-1.amazonaws.com:5432/dfpsv9fktf2hqh'] || "postgres://localhost/#{APP_NAME}_#{Sinatra::Application.environment}")
